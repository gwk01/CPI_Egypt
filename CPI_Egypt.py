...
with col3:
    #Month
    st.markdown(f'<p style="text-align:left;color:#0d0d0c;font-family:Arial Black;font-size:30px;border-radius:0%;">Egypt</p>', unsafe_allow_html=True)
...
if submit:
	...
	#send email
        ...
        msg['From'] = fromaddr
        msg['To'] = ", ".join(toaddr)
        msg['Subject'] = "NEW Egypt CPI Data"

        body = "Kindly, find attached the recently submitted CPI Data by Egypt NSO."
